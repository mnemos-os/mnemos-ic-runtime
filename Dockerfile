...
# InvestorClaw 4.1.18 ic-engine container — bridge image for the v4.1.18 application service
#
# Builds: mnemos-os/ic-engine:4.1.18-cpu
...
LABEL org.opencontainers.image.version="4.1.18"
