# RFC v0.1 — InvestorClaw 4.1.19 Application Service Architecture
...
│           │                                                      │
│  ┌──────────────────────┐                                        │
│  │  ic-engine:4.1.19-cpu       │  /data/ic-engine.db (sqlite WAL)       │
...
InvestorClaw 4.1.19 distribution = a single `compose.yml` at a stable URL
...
services:
  ...
  ic-engine:
    image: mnemos-os/ic-engine:4.1.19-cpu
    volumes: [data:/data]
    environment:
