...
user-invocable: true
metadata: {"license":"MIT-0","version":"4.1.20","runtime":"zeroclaw","image":"ghcr.io/argonautsystems/ic-engine:4.1.20-cpu","mcp-endpoint":"http://localhost:18090/mcp"}
---
...
- `mnemos-os/ic-engine:4.1.20-cpu` → `127.0.0.1:18090`
